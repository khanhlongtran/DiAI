...
import com.example.diai_app.adapters.CategoryAdapter;
import com.example.diai_app.adapters.ProductAdapter;
...
public class ShopFragment extends BaseFragment {
    ...
    private void seedData() {
        db.readListData("categories", CategoryDTO.class, Category.class, DataConverter::convertToCategoryDataModel, new FirebaseDatabaseManager.OnDataReadListener<List<Category>>() {
            @Override
        ...
        db.readListData("products", ProductDTO.class, Product.class, DataConverter::convertToProductDataModel, new FirebaseDatabaseManager.OnDataReadListener<List<Product>>() {
            @Override
